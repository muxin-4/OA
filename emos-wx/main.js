...
let baseUrl = "http://192.168.123.91:8080/emos-wx-api";
let api = "http://192.168.123.91:8090/emos-api";

Vue.prototype.tencent = {
  trtc: {
    appid: "AKIDkKglY5MM5XibDYdRyEDvMWVD3ex1oKZY",
  },
};
...
Vue.prototype.url = {
  ...
  approveTask: baseUrl + "/approval/approveTask",
  ...
  searchMeetingRoomByScan: baseUrl + "/meeting_room/searchMeetingRoomByScan",
  updateMeetingPresent: baseUrl + "/meeting/updateMeetingPresent",
  searchMeetingByScan: baseUrl + "/meeting/searchMeetingByScan",
};
